...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	static final int REFRESH_TOKEN_VALIDITY_SECONDS = 30 * 24 * 60 * 60;
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
		...
		endpoints
				.userDetailsService(userDetailService)	//need to add userDetailService for refreshToken
				.tokenStore(tokenStore())
				.authenticationManager(authenticationManager)
				.tokenEnhancer(tokenEnhancerChain());	//.exceptionTranslator(this::exceptionHandler);
	}
	
//	public ResponseEntity<OAuth2Exception> exceptionHandler(Exception e) throws Exception{
//		
//		if (e instanceof OAuth2Exception && e.getMessage().equalsIgnoreCase(BAD_CREDENTIAL)) {
//            OAuth2Exception oAuth2Exception = (OAuth2Exception) e;
//            return ResponseEntity
//                    .status(oAuth2Exception.getHttpErrorCode())
//                    .body(new OAuth2Exception("Invalid user name or password"));
//        }
//		throw e;
//	}
